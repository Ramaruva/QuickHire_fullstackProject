    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(
                        req -> req.requestMatchers("/login/**","/professionalRegister/**")
                                .permitAll()
                                .requestMatchers("/createStaff").hasAuthority(String.valueOf(AllTypesEnums.UserType.ROOT))
                                .requestMatchers("/getAllProfessionalRequests/**","/professionalRequestReview/**").hasAuthority(String.valueOf(AllTypesEnums.UserType.STAFF))
                                .anyRequest()
                                .authenticated()
